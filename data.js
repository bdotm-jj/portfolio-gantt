// data.js — regenerated by the GitHub Action (see .github/workflows/refresh-data.yml).
// Defines the three globals the app reads. Do not hand-edit; edit the source sheets instead.
// Row shapes:
//   PROJECTS: [name, pod, lob, status, stage, planStart, planEnd, actStart, actEnd, manualOrder]
//   QUEUE:    [name, lob, order, stage]
//   BACKLOG:  [name, lob, order|null]
window.LAST_REFRESH = '(static snapshot — not yet live)';
var SNAPSHOT = [
