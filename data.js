...
window.LAST_REFRESH = "2026-07-22T16:13:58.228Z";
var SNAPSHOT = [
  ["HVH: Indication API","Motion Pod","Motion - HVH","Not Started","Discovery","2025-12-03","2026-02-20","2025-12-03","2026-01-20",null],
  ["Scottsdale API","PL Pod","Personal Lines","In-Progress","Hypercare","2025-10-13","2026-01-13","2025-09-22","2026-03-10",0],
  ...
  ["Markel State Expansion - Group 6 (MI, MN, MT, ND, SD, WI)","PL Pod","Personal Lines","","","2026-01-06","2026-02-16","2026-01-06","2026-02-25",null],
  ["Markel X-Wind Barrier Island API","PL Pod","Personal Lines","","","2026-02-26","2026-03-25","2026-02-25","2026-02-26",null],
  ["Automation: Self-Serve / rules","Motion Pod","Motion - HVH","In-Progress","Discovery","2026-02-17","2026-04-01","2026-01-30","2026-09-29",null],
  ["GLISE State Expansion  - Group 2 (AZ, KY, NM, NV, OR, WA)","PL Pod","Personal Lines","","","2026-04-06","2026-05-15","2026-02-25","2026-04-06",null],
  ...
  ["VAVE State Expansion - Group 2 (AZ, CA, CO, NV)","PL Pod","Personal Lines","","","2026-04-13","2026-05-22","2026-02-25","2026-04-13",null],
  ["MeshVI Integration","Other","JJOA","In-Progress","Discovery","2026-04-06","2026-05-21","2026-04-06","2026-09-14",1],
  ["JJCM - New MARS Claims System for JJCM","Other","Support/Specialty","In-Progress","Discovery","2026-04-27","2026-05-20","2026-04-27","2026-07-01",4],
  ...
  ["Risk Based Pricing","PL Pod","Personal Lines","","","2026-05-04","2026-06-30","2026-02-25","2026-05-04",0],
  ["Condo Rater – New UI","PL Pod","Personal Lines","On Hold","Development","2026-02-04","2026-07-10","2025-07-25","2026-05-12",9],
  ["Motion HVH API","PL Pod","Personal Lines","On Hold","Development","2026-04-20","2026-07-20","2026-04-20","2026-05-15",5],
  ["GLISE State Expansion  - Group 3 (MI, MN, ND, SD, WI, MT)","PL Pod","Personal Lines","","","2026-05-19","2026-07-01","2026-02-25","2026-05-19",null],
  ["VAVE State Expansion - Group 3 (KY, NM, OR, UT, WA)","PL Pod","Personal Lines","","","2026-05-27","2026-07-08","2026-02-25","2026-05-27",null],
  ...
  ["Launch of Course of Construction (COC)","Motion Pod","Motion - COC","In-Progress","Development","2026-03-10","2026-05-19","2026-02-12","2026-06-24",null],
  ["Mailing Suppression","Other","Support/Specialty","At Risk","UAT - Operations","2026-05-15","2026-07-07","2026-05-25","2026-07-24",3],
  ["Excess Wind transition to MARS – UI, additional companies, rating","PL Pod","Personal Lines","","","2026-07-02","2026-11-19","2026-02-25","2026-07-02",null],
  ["VAVE New Company Set Up","PL Pod","Personal Lines","In-Progress","Development","2026-02-12","2026-04-09","2026-04-10","2026-07-08",0],
  ["VAVE State Expansion - Group 4 (MI, MN, MT, ND, OK, SD, WI)","PL Pod","Personal Lines","","","2026-07-10","2026-07-20","2026-02-25","2026-07-10",null],
  ...
  ["Transportation Rater Update","CL Pod","Commercial Lines","On Hold","Blocked","2026-06-01","2026-07-01","2026-05-19","2026-07-14",0],
  ["Auto Renewals - PL","Mission Control","Support/Specialty","At Risk","Development","2025-09-02","2025-11-14","2024-09-02","2026-07-02",2],
  ["Markel Capacity Program","CL Pod","Commercial Lines","In-Progress","Development","2026-02-02","2026-03-13","2026-02-02","2026-08-24",0],
  ["Agency Fees Management","Other","Support/Specialty","At Risk","Development","2025-10-14","2026-02-04","2025-10-15","2026-08-26",1],
  ["Earthquake transition to MARS – UI, additional companies, rating","PL Pod","Personal Lines","","","2026-08-12","2026-10-21","2026-02-25","2026-08-12",null],
  ["VAVE State Expansion - Group 5 (ID, IL, IN, OH)","PL Pod","Personal Lines","","","2026-08-24","2026-10-05","2026-02-25","2026-08-24",null],
  ["Markel State Expansion - Group 3 (CA, CT, GA, KY, MA, ME, TX, VA)","PL Pod","Personal Lines","","","2026-08-31","2026-10-12","2026-02-25","2026-08-31",null],
  ...
  ["Markel State Expansion - Group 5 (ID, LA, NY, OK, TN, UT)","PL Pod","Personal Lines","","","2026-10-14","2026-11-24","2026-02-25","2026-10-14",null],
  ["Markel State Expansion - Group 4 (AZ, MD, NV, NC, NH, PA, RI, VT)","PL Pod","Personal Lines","","","2026-11-19","2027-01-04","2026-02-25","2026-11-19",null],
  ["Excess Property - MA & NC","PL Pod","Personal Lines","","","2026-11-23","2027-02-03","2026-02-25","2026-11-23",null],
  ["2026 Wholesaler Onboarding","Motion Pod","Motion Pod","","","2026-03-03","2026-05-04","2026-01-01","2026-12-31",null],
  ["Quote Rush Integration","Flood Pod","Flood","On Hold","Discovery","2027-03-05","2027-05-13","2026-02-25","2027-03-05",3],
  ["Munich RE - Commercial","Flood Pod","Flood","In-Progress","QA - Internal","2026-02-18","2026-04-29","2026-02-18","2026-08-17",0],
  ["JJPF INTEREST INCOME OPTIMIZATION","Architecture","Tech Initiative","In-Progress","Discovery","2026-06-08","2026-06-22","2026-06-08","2026-09-25",4],
  ["Condo Launch","Motion Pod","Motion - Condos","On Hold","Discovery","2026-06-18","2026-08-21","2026-02-25","2026-06-18",null],
  ["Quote Funnel Dashboard","Data Reporting Pod","Data Reporting Team","In-Progress","Development","2026-05-13","2026-07-13","2026-05-13","2026-09-11",null],
  ["Workflow Dashboard","Data Reporting Pod","Data Reporting Team","At Risk","UAT - Operations","2026-01-01","2026-07-01","2026-01-01","2026-08-10",null],
  ...
  ["Transportation Installment Invoices - Net Bill Agencies","CL Pod","Commercial Lines","","","2026-07-13","2026-09-14","2026-02-25","2026-07-13",6],
  ["Coverforce SSO for Workers Comp","CL Pod","Commercial Lines","","","2026-07-13","2026-09-14","2026-02-25","2026-07-13",1]
];
